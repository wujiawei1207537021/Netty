...
public class PacketDecoderUtils {
    ...
    public static byte[] decoderEscape(ByteBuf buf) {
        ...
        CommonUtils.PACKET_CACHE.put(Thread.currentThread().getName(), packetInfo.toString());
     ...
     * @param packet
     */
    public static ByteBuf baseDecoder(byte[] bytes, MessageStructureAbstract packet) throws Exception {
